...
ChatBot::~ChatBot()
{
    ...
    bool flag = (_image != NULL && _image != nullptr);
    //std::cout << flag << std::endl;
    if(_image != NULL && _image != nullptr) // Attention: wxWidgets used NULL and not nullptr
    {
        //std::cout << "prepare to delete image." << std::endl;
        delete _image;
        //std::cout << "finished delete image." << std::endl;
        _image = NULL;
...
ChatBot::ChatBot(const ChatBot &source) {
    //std::cout << "COPYING ChatBot instance " << &source << " to instance " << this << std::endl;
